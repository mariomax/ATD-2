...
<section class="thumbs">
    ...
    <a href="http://www.anchortagdesign.com/boots4" target="_blank" rel="nofollow noopener" class="overlay-text">
        ...
        <div class="overlay">
            ...
            <p class="p-on-hover">This sample site is built with Bootstrap, a popular and versitile front-end framework for web development. It features HTML &amp; CSS templates for forms, buttons, navigation systems other elements for building responsive web design.</p>   
        </div>
    </a>
